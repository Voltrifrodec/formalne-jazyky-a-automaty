...
\begin{document}
    ...
    \noindentfix Vytvorenie .jar súboru a spustenie aplikácie (môže vyžadovať nainštalovaný \HighlightedTextLightgray{mvn}; spúšťame v priečinku \HighlightedTextLightgray{content/zadanie-1/aplikacia}):

    \noindentfix \fcolorbox{black}{gray!30}{
        \parbox{\linewidth}{
            \texttt{mvn clean package}\linebreak\texttt{java -jar ./target/kubaliak-zadanie-1.jar}
        }
    }
    ...
    \noindentfix \fcolorbox{black}{gray!30}{
        \parbox{\linewidth}{
            \texttt{java -jar ./target/kubaliak-zadanie-1.jar}
        }
    }
    ...
    \noindentfix \fcolorbox{black}{gray!30}{
        \parbox{\linewidth}{
            \texttt{java -jar ./target/kubaliak-zadanie-1.jar test-retazcov.txt}
        }
    }
